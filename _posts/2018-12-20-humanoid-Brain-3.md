...
* Real-time Single Object Detection And Classification: In this I combined two Deep-learning Algorithms in real-time namely:
  ![](/img/in-post/manav/brain-3-3.png)
  * Detection - a process of identification 
  ![](/img/in-post/manav/brain-3-4.png)
  * Classification - categorization of the object based on a previously defined classes or types. 
