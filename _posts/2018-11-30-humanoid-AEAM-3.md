...
{:.image-caption}*YouTube State of the art stabilizer*
...
2. MeshFlow Controlled Predicted Adaptive Path (PAPs) based Video Stabilization - [Research Paper](https://link.springer.com/chapter/10.1007/978-3-319-46466-4_48)  
...
{:.image-caption}*Video Stabilization Using Point Feature Matching*
...
{:.image-caption}*Video Stabilization algorithm*
...
{:.image-caption}*Feature Points in Frame A and B*
...
{:.image-caption}*Correspondences Between Frames A and B*
...
{:.image-caption}*New transformation applied*
...
### 2. MeshFlow Controlled Predicted Adaptive Path based Video Stabilization:  
...
{:.image-caption}*Median Filters f1 & f2*
...
{:.image-caption}*Predicted Adaptive Path Smoothing (PAPS)*
...
{:.image-caption}*MeshFlow Controlled Predicted Adaptive Path (PAPs) based Video Stabilization*
...
{:.image-caption}*MeshFlow Controlled Predicted Adaptive Path (PAPs) based Video Stabilization output*
